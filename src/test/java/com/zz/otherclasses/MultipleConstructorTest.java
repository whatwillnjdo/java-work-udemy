...
public final class MultipleConstructorTest {
    ...
    public void ShouldCallAConstructorWithAllParameters() {
        ...
        MatcherAssert.assertThat(multipleConstructor.getName(), Is.is("NJ"));
    ...
    public void ShouldCallAConstructorWithNoParameters() {
        ...
        MatcherAssert.assertThat(multipleConstructor.getCreditLimit(), Is.is(100D));
        MatcherAssert.assertThat(multipleConstructor.getEmailAddress(), Is.is("noemail@email.com"));
    }
}
